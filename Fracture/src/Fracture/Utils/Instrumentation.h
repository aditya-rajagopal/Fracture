...
#ifndef FR_DIST
#define FR_PROFILE_SCOPE(name) ::Fracture::InstrumentationTimer timer##__LINE__(name)
#define FR_PROFILE_FUNCTION() FR_PROFILE_SCOPE(__FUNCSIG__)
#define FR_BEGIN_PROFILE_SESSION(name, filepath) ::Fracture::Instrumentor::Get().BeginSession(name, filepath)
#define FR_END_PROFILE_SESSION() ::Fracture::Instrumentor::Get().EndSession()
#else
